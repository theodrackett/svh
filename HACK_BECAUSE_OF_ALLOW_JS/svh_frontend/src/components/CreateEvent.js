...
const CreateEvent = () => {
    ...
    function addEvent(newEvent) {
        setEvents(prevEvents => {
            svh_backend.createEvent(newEvent.category, newEvent.city, newEvent.contact, newEvent.country, newEvent.creator, newEvent.description, newEvent.email, newEvent.fromDate, newEvent.name, newEvent.phone, newEvent.state, newEvent.street, newEvent.toDate, newEvent.webSite, newEvent.frequency, newEvent.id, newEvent.rating, newEvent.lat, newEvent.lon);
